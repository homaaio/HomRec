 ...
 * Uses an int64_t accumulator to handle large buffers safely, avoiding the
 * integer overflow a narrower accumulator would hit.
 * ---------------------------------------------------------------------- */
 ...
 * Uses proper +128 rounding (not the biased +127>>8 shortcut) when
 * dividing by 256.
 * ---------------------------------------------------------------------- */
