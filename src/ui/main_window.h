...
private:
    ...
    // Dynamic label text + colors (status_label/status_icon/time_label/
    // fps_label/res_label/file_label) - these are just fields redrawn on
    // InvalidateRect
    ...
    // True borderless fullscreen (not just maximize): remembers the
    // pre-fullscreen style/rect so it can be
