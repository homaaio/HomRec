...
LANGUAGES = {
    "en": {
        "app_title": "HomRec v1.6.5", "live_preview": "PREVIEW", "ready": "Ready",
    ...
    "ru": {
        "app_title": "HomRec v1.6.5", "live_preview": "ПРЕДПРОСМОТР", "ready": "Готов",
...
class HomRecScreen:
    def __init__(self, root: tk.Tk) -> None:
        ...
        self.setup_tray()
        log.info("HomRec v1.6.5 started, language: %s", self.current_language)
    ...
    def create_widgets(self) -> None:
        ...
        tk.Label(title_frame, text="v1.6.5", font=("Segoe UI", 11), bg=self.colors["surface"], fg=self.colors["text_secondary"]).pack()
